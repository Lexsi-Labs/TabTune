...
from tabtune.models.tabpfnv3.architectures.shared.fa3_backend import fa3_attn_func, is_fa3_preferred
from tabtune.models.tabpfnv3.architectures.shared.mlx_backend import (
    flash_attention_mlx,
    is_mlx_preferred,
)
