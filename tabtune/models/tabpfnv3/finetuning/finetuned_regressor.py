...
from tabtune.models.tabpfnv3.finetuning.train_util import clone_model_for_evaluation

logger = logging.getLogger(__name__)

if TYPE_CHECKING:
    from tabtune.models.tabpfnv3.constants import XType, YType
    from tabtune.models.tabpfnv3.finetuning.data_util import RegressorBatch
    from tabtune.models.tabpfnv3.finetuning.logging import FinetuningLogger
    from tabtune.models.tabpfnv3.regressor import RegressionResultType
