...
# Lazy accessors — use these instead of module-level imports to avoid
# the base ↔ model_loading ↔ regressor circular dependency.
def _TabPFNClassifier():
    from .classifier import TabPFNClassifier
    return TabPFNClassifier

def _TabPFNRegressor():
...
def log_model_init_params(
    ...
    if logged_params:
        try:
            ...
            from ._compat.telemetry import set_init_params  # noqa: PLC0415
